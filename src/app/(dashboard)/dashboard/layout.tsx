          ...
          {sidebarOptions.map((option) => {
            ...
            return (
              <li key={option.id}>
                ...
                >
                  <span className="text-gray-400 border border-gray-200 group-hover:border-indigo-600 flex h-6 w-6 shrink-0 justify-center items-center rounded-lg text-[0.625rem] font-semibold bg-white">
