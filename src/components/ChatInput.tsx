...
const ChatInput: FC<ChatInputProps> = ({
  ...
  return <div className="border-t border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
    <div className="relative flex-1 overflow-hidden rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
      ...
      className="block w-full resize-none bg-transparent border-0 placeholder:text-gray-400 text-gray-900 focus:ring-0 sm:py-1.5 sm:leading-6"
      />
      ...
      <div className="absolute right-0 bottom-2 flex justify-between px-2 pl-3 pr-2">
