...
interface FirendRequestsSidebarOptionProps {
  sessionId: string
  initialUnseenRequestCount: number
}
const FirendRequestsSidebarOptions: FC<FirendRequestsSidebarOptionProps> = ({
  sessionId,
...
export default FirendRequestsSidebarOptions